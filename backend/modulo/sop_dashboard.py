...
SELECT 'Producao' as Tipo, CODIGO_MATERIAL AS Codigo,
  ...
  SUM(SAFE_CAST(QUANTIDADE AS FLOAT64)) AS Qtd_Real
FROM `projeto-rpa-blackd-2023.VENDAS.ApontamentosProducao`
...
WITH CombinedEstoque AS (
  ...
  FROM `projeto-rpa-blackd-2023.VENDAS.EstoqueProducao`
...
FROM `projeto-rpa-blackd-2023.VENDAS.opemaberto`
